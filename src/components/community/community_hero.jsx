...
const Hero = () => {
    return (
        <div className="relative h-screen">
            ...
            >
                <div className="px-6 md:px-20 rounded-lg text-center md:text-left text-offwhite max-w-4xl mt-36">

                    <h2 className='text-4xl md:text-6xl drop-shadow-2xl text-center md:text-left'>Become a part of the community!</h2>
                    <p className="text-xl md:text-xl mb-8 break-words whitespace-pre-wrap pr-0 md:pr-36">
